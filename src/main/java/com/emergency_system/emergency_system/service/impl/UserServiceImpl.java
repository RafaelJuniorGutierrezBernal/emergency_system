...
import com.emergency_system.emergency_system.mapper.UserMapper;
...
public class UserServiceImpl implements UserService {
    ...
    public UserEntity save(UserEntity user) {
        ...
        Assert.hasText(user.getFirstName(), "El nombre del usuario no puede estar vacío");
        Assert.hasText(user.getLastName(), "El apellido del usuario no puede estar vacío");
        // Validación del nombre con caracteres especiales
        if (!NAME_PATTERN.matcher(user.getFirstName()).matches() || !NAME_PATTERN.matcher(user.getLastName()).matches()) {
